...
TEMPLATE                             = app
VERSION                              = 1.0alpha14
SOURCES                             += src/main.cpp src/mainwindow.cpp src/backend.cpp src/wizard.cpp src/preferences.cpp
HEADERS                             += src/mainwindow.h src/backend.h src/wizard.h src/preferences.h
FORMS                               += src/mainwindow.ui src/wizard.ui src/preferences.ui
...
RCC_DIR                              = $${DESTDIR}/.qrc
UI_DIR                               = $${DESTDIR}/.ui
OTHER_FILES += UserPKG.spec UserPKG.SlackBuild
